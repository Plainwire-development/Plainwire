...
async function setup(uid) {
  ...
  await context.route('**/api/**', async route => {
    ...
    if (path === '/api/client-config') return route.fulfill({ json: { app_name: 'Plainwire', default_theme: 'system', version: '1.7.5-1', asset_version: '1.7.5-1', registration_enabled: true } });

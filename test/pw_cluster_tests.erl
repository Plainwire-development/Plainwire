...
wire_validation_test() ->
    ...
    ?assertEqual(true, pw_cluster_wire:allowed({topic, {channel, 1}}, #{type => message_reaction_changed})),
    ?assertEqual(true, pw_cluster_wire:allowed({topic, {channel, 1}}, #{type => message_pin_changed})),
    ?assertEqual(true, pw_cluster_wire:allowed({user, 1}, #{type => notification})),
    ?assertEqual(true, pw_cluster_wire:allowed({user, 1}, #{type => account_restricted})),
    ?assertEqual(true, pw_cluster_wire:allowed({user, 1}, #{type => account_restored})),
    ?assertEqual(true, pw_cluster_wire:allowed({user, 1}, #{type => account_disabled})),
    ?assertEqual(true, pw_cluster_wire:allowed({user, 1}, #{type => account_deleted})),
    ?assertEqual(true, pw_cluster_wire:allowed({user, 1}, #{type => sessions_revoked})),
    ?assertEqual(true, pw_cluster_wire:allowed({user, 1}, #{type => bot_command_available})),
    ?assertEqual(true, pw_cluster_wire:allowed({user, 1}, #{type => bot_command_failed})),

...
// Planning model only. Plainwire 2.3.0 intentionally keeps one realtime owner;
...
pub fn gateways(
  ...
  let headroom_multiplier = 100 + headroom
  let planned_users = ceil_div(users * headroom_multiplier, 100)
  ShardPlan(
    users: users,
